...
// func NewJobWithResult[T any](f func(ctx context.Context, args ...any) (T, error)) (*Job[T], error) {
// 	j, err := NewJob()
// 	if err != nil {
// 		return nil, err
// 	}
...
// func (j *Job[T]) execute(ctx context.Context, args ...any) (T, error) {
